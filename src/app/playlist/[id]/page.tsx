        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="hidden sm:flex items-center gap-2 ml-4">
              <Link href="/browse" className="px-3 py-1.5 text-sm text-[#a1a1a6] hover:text-white transition-colors">Browse</Link>
              <Link href="/dashboard" className="px-3 py-1.5 text-sm text-[#a1a1a6] hover:text-white transition-colors">Dashboard</Link>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/dashboard" className="px-6 py-2.5 bg-gradient-to-r from-[#6366f1] to-[#a855f7] text-white rounded-full font-semibold hover:shadow-lg transition-all">
              Publish Channel
            </Link>
          </div>
        </div>
