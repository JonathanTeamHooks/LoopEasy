      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-700 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'}`}>
        <div className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link href="/auth" className="px-5 py-2.5 bg-[#00d4ff] hover:bg-[#33ddff] text-black text-sm font-semibold rounded-full transition-all hover:shadow-[0_0_30px_rgba(0,212,255,0.4)]">
              Get Started
            </Link>
          </div>
        </div>
      ...
      <main className="relative pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            >
              <Link href="/auth" className="w-full sm:w-auto px-8 py-4 bg-[#00d4ff] hover:bg-[#33ddff] text-black font-semibold rounded-full transition-all hover:shadow-[0_0_40px_rgba(0,212,255,0.5)] hover:scale-105 text-center">
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative">
            ...
            <div className="relative bg-[#141416] border border-[#2a2a2e] rounded-3xl p-12 md:p-16">
              ...
              <Link href="/auth" className="inline-block px-10 py-4 bg-[#00d4ff] hover:bg-[#33ddff] text-black font-semibold rounded-full transition-all hover:shadow-[0_0_50px_rgba(0,212,255,0.5)] hover:scale-105 text-lg">
