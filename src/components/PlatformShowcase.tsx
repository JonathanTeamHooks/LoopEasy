    ...
    <section id="platform-showcase" className="py-32 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        ...
        <div className="flex flex-wrap justify-center gap-4 mt-12">
          <a href="#" className="flex items-center gap-3 px-6 py-3 bg-black border border-[#2a2a2e] rounded-xl hover:border-[#6366f1]/50 transition-all group">
          ...
          <a href="#" className="flex items-center gap-3 px-6 py-3 bg-[#FF9900] text-black rounded-xl hover:bg-[#ffaa22] transition-all group">
